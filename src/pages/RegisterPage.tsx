  ...
  return (
    <div className="min-h-screen flex relative">
      ...
      <motion.div
        ...
        style={{ background: "linear-gradient(135deg, hsl(189 35% 43%), hsl(145 30% 56%))" }}
      >
        <div className="absolute inset-0 bg-grid opacity-10" />
        <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-[hsl(252_52%_23%)] rounded-full blur-[120px] opacity-20" />
        <div className="absolute bottom-1/3 right-1/3 w-48 h-48 bg-[hsl(65_60%_73%)] rounded-full blur-[100px] opacity-15" />
        ...
        <div className="relative z-10 text-center px-12">
          ...
          >
            Bergabung sekarang dan jelajahi dunia sepak bola tanpa batas
          </motion.p>
        </div>
      </motion.div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-background p-8">
        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-display font-bold text-foreground">Buat Akun Baru</h1>
            <p className="text-muted-foreground text-sm mt-2">Daftar untuk mulai menjelajahi</p>
          </div>
